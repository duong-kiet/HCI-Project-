...
// const TOKEN = "007eJxTYGhf8zV16qtLTg/MCrglBV5eTVOIczW/9uWneQeLxp/bx50VGJItkpNSU42MUtLSkkxSkhMtUs3NDRJNDZNSjJLNkswMhM64pTcEMjLErbjJyMgAgSA+M4OhkTEDAwCwxCBL"; // Điền Token của bạn (hoặc null nếu không cần)
const TOKEN = "007eJxTYDj5+ova3b9SXvVNJ7Typ83qN7lydyq3oVync9PUrZdrl8UoMCRbJCelphoZpaSlJZmkJCdapJqbGySaGialGCWbJZkZ/JT3TG8IZGTYKXKehZEBAkF8ZgZDI2MGBgDdaCCs"
...
//   const [remoteAudioTracks, setRemoteAudioTracks] = useState([]); // Thêm state cho remote audio tracks
            ...
            {joined && (
              <div className="flex flex-col items-center">
                <WaveformVisualizer 
                  localAudioTrack={localAudioTrack}
                  remoteAudioTracks={remoteAudioTracks}
                  // remoteAudioTracks={remoteAudioTracks.filter(
                  //   (track) => track.id !== localAudioTrack.id
                  // )} 
                  // mutedTracks={[localAudioTrack]}
                />
                <button
                  className="group relative"
                  onClick={() => {
