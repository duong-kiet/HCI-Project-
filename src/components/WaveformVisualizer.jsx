...
// //     return () => {
// //       if (animationRef.current) {/-strong/-heart:>:o:-((:-h // //         cancelAnimationFrame(animationRef.current);
// //       }
// //     };
// //   }, [analyser, dataArray]);
...
//       setError('Không thể truy cập microphone. Vui lòng cấp quyền và thử lại.');
//     }
//   };/-strong/-heart:>:o:-((:-h //   const setupRemoteAudio = () => {
...
//               Microphone của bạn
//             </div>/-strong/-heart:>:o:-((:-h //             <div className="bg-gray-900 rounded-lg overflow-hidden" style={{ aspectRatio: '1/1' }}>
//               <canvas
//                 ref={localCanvasRef}
//                 className="w-full h-full"
//                 width={512}
...
//                 >
//                   <div className="absolute -inset-2 bg-gradient-to-r from-red-400 to-pink-500 rounded-full blur opacity-40 group-hover:opacity-75 transition"></div>
//                     <div className="relative bg-slate-800 p-4 rounded-full border border-red-400 hover:border-pink-400 transition">/-strong/-heart:>:o:-((:-h //                       <MicOff className="w-8 h-8 text-red-400 group-hover:text-pink-400" />
//                     </div>
//                 </button>
//               )}
...
const WaveformVisualizer = () => {
    ...
    useEffect(() => {
        const animate = () => {
            ...
            if (remoteCanvasRef.current && isCallActive) {
                drawWaveform(remoteCanvasRef.current, remoteAnalyser, remoteDataArray, 'rgb(0, 191, 255)', mutedRemote);
            }
            animationRef.current = requestAnimationFrame(animate);
        };
    ...
    }, [localAnalyser, remoteAnalyser, localDataArray, remoteDataArray, isCallActive, mutedLocal, mutedRemote]);
